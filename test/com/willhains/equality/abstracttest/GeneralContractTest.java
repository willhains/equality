...
public abstract class GeneralContractTest<T> extends AbstractTest<T>
{
	...
	@Test
	public void reflexivity() throws Exception
	{
		final T o1 = createImp();
		assertEquals(o1, o1);
	}
	...
	@Test
	public void transitivity() throws Exception
	{
		final T o1 = createImp();
		final T o2 = createImp();
	...
	@Test
	public void nonNullity() throws Exception
	{
		final T o1 = createImp();
	...
	@Test
	public void equalsHashCodeConsistency() throws Exception
	{
		final T o1 = createImp();
		final T o2 = createImp();
